...
!(function () {
  ...
  (function () {
    ...
    var E = N[H],
      ...
      _ = !1;
    r &&
      ((_ = (f.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(f.readyState)) ||
      ...
      return {
        ...
        inner: {
          transform:
            ...
            ') ' +
            ' ' +
            ('scale(' + (l.size / 16) * (l.flipX ? -1 : 1) + ', ' + (l.size / 16) * (l.flipY ? -1 : 1) + ') ') +
            ' ' +
            ('rotate(' + l.rotate + ' 0 0)'),
        },
    ...
    var Q = { x: 0, y: 0, width: '100%', height: '100%' },
      Z = function (c) {
        var l = c.children,
          ...
          r = { tag: 'g', attributes: S({}, f.inner), children: [{ tag: 'path', attributes: S({}, a.attributes, f.path, { fill: 'black' }) }] },
          ...
          V = {
            ...
            children: [
              ...
              { tag: 'mask', attributes: S({}, Q, { id: i, maskUnits: 'userSpaceOnUse', maskContentUnits: 'userSpaceOnUse' }), children: [M, H] },
            ],
          };
        return (
          l.push(V, { tag: 'rect', attributes: S({ fill: 'currentColor', 'clip-path': 'url(#' + n + ')', mask: 'url(#' + i + ')' }, Q) }),
      ...
      $ = function (c) {
        ...
        if ((0 < e.length && (h.style = e), G(z))) {
          var m = J({ transform: z, containerWidth: v.width, iconWidth: v.width });
          l.push({
            tag: 'g',
            ...
            children: [
              {
                ...
                children: [{ tag: v.icon.tag, children: v.icon.children, attributes: S({}, v.icon.attributes, m.path) }],
              },
            ],
          });
        } else l.push(v.icon);
      ...
      cc = function (c) {
        ...
        if (G(m) && h.found && !v.found) {
          var a = h.width / h.height / 2,
            s = 0.5;
          z.style = K(S({}, e, { 'transform-origin': a + m.x / 16 + 'em ' + (s + m.y / 16) + 'em' }));
        }
      ...
      lc = function (c) {
        ...
        return [{ tag: 'svg', attributes: { style: 'display: none;' }, children: [{ tag: 'symbol', attributes: S({}, z, { id: m }), children: v }] }];
      };
    function hc(c) {
      var l = c.icons,
        h = l.main,
      ...
      M && (o.attributes[g] = ''), s && o.children.push({ tag: 'title', attributes: { id: o.attributes['aria-labelledby'] || 'title-' + B() }, children: [s] });
      var C = S({}, o, { prefix: z, iconName: e, main: h, mask: v, transform: m, symbol: a, styles: t.styles }),
    ...
    function vc(c) {
      var l = c.content,
        ...
        a = c.watchable,
        s = void 0 !== a && a,
        t = S({}, m.attributes, e ? { title: e } : {}, { class: m.classes.join(' ') });
      s && (t[g] = '');
      var f,
        M,
        r,
      ...
      G(z) &&
        ((L.transform =
          ((M = (f = { transform: z, startCentered: !0, width: h, height: v }).transform),
          (r = f.width),
          (H = void 0 === r ? b : r),
          (i = f.height),
          (n = void 0 === i ? b : i),
          ...
          (C +=
            (o = void 0 !== V && V) && p
              ? 'translate(' + (M.x / F - H / 2) + 'em, ' + (M.y / F - n / 2) + 'em) '
              : o
              ? 'translate(calc(-50% + ' + M.x / F + 'em), calc(-50% + ' + M.y / F + 'em)) '
              : 'translate(' + M.x / F + 'em, ' + M.y / F + 'em) '),
          (C += 'scale(' + (M.size / F) * (M.flipX ? -1 : 1) + ', ' + (M.size / F) * (M.flipY ? -1 : 1) + ') '),
          (C += 'rotate(' + M.rotate + 'deg) '))),
        (L['-webkit-transform'] = L.transform));
      var u = K(L);
      0 < u.length && (t.style = u);
      var d = [];
      return d.push({ tag: 'span', attributes: t, children: [l] }), e && d.push({ tag: 'span', attributes: { class: 'sr-only' }, children: [e] }), d;
    }
    var zc = function () {},
      ec = O.measurePerformance && t && t.mark && t.measure ? t : { mark: zc, measure: zc },
      mc = 'FA "5.0.13"',
      ac = function (c) {
        ...
        var z,
          ...
          M =
            void 0 !== v
              ...
              : l;
        for (void 0 === h ? ((z = 1), (m = c[t[0]])) : ((z = 0), (m = h)); z < f; z++) m = M(m, c[(e = t[z])], e, c);
        return m;
      },
      fc = E.styles,
      Mc = E.shims,
        ...
        ic = tc(
          ...
          function (c, l) {
            var h = l[0],
              v = l[1],
              z = l[2];
            return 'far' !== v || e || (v = 'fas'), (c[h] = { prefix: v, iconName: z }), c;
          },
          {}
        );
      };
    ...
    function Cc(c) {
      return c.reduce(function (c, l) {
        ...
        if (Vc[l]) c.prefix = l;
          ...
          var v = 'fa' === c.prefix ? ic[h] || { prefix: null, iconName: null } : {};
      ...
      Fc = {
        ...
        children: [
          _c,
          {
            ...
            children: [
              { tag: 'animate', attributes: S({}, Pc, { attributeName: 'r', values: '28;14;28;28;14;28;' }) },
              { tag: 'animate', attributes: S({}, Tc, { values: '1;0;1;1;0;1;' }) },
            ],
          },
          {
            tag: 'path',
            ...
            children: [{ tag: 'animate', attributes: S({}, Tc, { values: '1;0;0;0;0;1;' }) }],
          },
          {
            tag: 'path',
            attributes: S({}, Ec, {
            ...
            children: [{ tag: 'animate', attributes: S({}, Tc, { values: '0;0;1;1;0;0;' }) }],
          },
        ],
      },
      Ic = E.styles,
    ...
    function Dc(c, l) {
      ...
      if (c && l && Ic[l] && Ic[l][c]) {
        var v = Ic[l][c];
        h = { found: !0, width: v[0], height: v[1], icon: { tag: 'path', attributes: { fill: 'currentColor', d: v.slice(4)[0] } } };
    ...
    function Xc(c) {
      var l,
        ...
        u =
          ...
          (t = Oc(l)),
          (f = jc(l)),
          { iconName: v, title: l.getAttribute('title'), prefix: z, transform: a, symbol: s, mask: f, extra: { classes: e, styles: m, attributes: t } });
      return ~u.extra.classes.indexOf(Rc)
        ? (function (c, l) {
            ...
            return (
              ...
              [c, vc({ content: c.innerHTML, width: e, height: m, transform: v, title: h, extra: z, watchable: !0 })]
            );
          })(c, u)
        : ((M = c),
          (H = (r = u).iconName),
      ...
      el =
        ((vl = function (c) {
          ...
          if (c) {
            ...
            return ll(S({ type: 'icon' }, c), function () {
              return (
                cl(),
                O.autoA11y && (t ? (H['aria-labelledby'] = O.replacementClass + '-title-' + B()) : (H['aria-hidden'] = 'true')),
                hc({
                  icons: { main: Zc(C), mask: a ? Zc(a.icon) : { found: !1, width: null, height: null, icon: {} } },
                  prefix: V,
                  iconName: o,
                  transform: S({}, I, v),
                  symbol: e,
        ...
        function (c) {
          var l = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
            h = (c || {}).icon ? c : hl(c || {}),
            v = l.mask;
          return v && (v = (v || {}).icon ? v : hl(v || {})), vl(h, S({}, l, { mask: v }));
        }),
      ml = {
        noAuto: function () {
          var c;
          j({ autoReplaceSvg: (c = !1), observeMutations: c }), yc && yc.disconnect();
        },
        dom: {
          i2svg: function () {
        ...
        text: function (c) {
          ...
          return ll({ type: 'text', content: c }, function () {
            return (
              cl(),
              vc({ content: c, transform: S({}, I, v), title: e, extra: { attributes: t, styles: M, classes: [O.familyPrefix + '-layers-text'].concat(k(a)) } })
            );
          });
        },
        layer: function (c) {
                    ...
                    (yc = new s(function (c) {
                      wc ||
                        D(c).forEach(function (c) {
                          if (
                            ('childList' === c.type && 0 < c.addedNodes.length && !pc(c.addedNodes[0]) && (O.searchPseudoElements && m(c.target), z(c.target)),
                            'attributes' === c.type && c.target.parentNode && O.searchPseudoElements && m(c.target.parentNode),
                            'attributes' === c.type && pc(c.target) && ~u.indexOf(c.attributeName))
                          )
